...
var scss = function scss() {
  return app.gulp.src(app.path.src.scss, {
  ...
  })).pipe((0, _gulpGroupCssMediaQueries["default"])()).pipe((0, _gulpWebpcss["default"])({
    webpClass: ".webp",
    noWebpClass: ".no-webp"
    ...
    cascade: true
  })).pipe(app.gulp.dest(app.path.build.css)).pipe((0, _gulpCleanCss["default"])()).pipe((0, _gulpRename["default"])({
    extname: ".min.css"
